...
public class AwsAdotInstrumenterFactory {
  ...
  public AwsAdotInstrumenterFactory(OpenTelemetry openTelemetry // GlobalOpenTelemetry.get()
      ) {
  ...
  Instrumenter<ExecutionAttributes, Response> requestInstrumenter() {
    return createInstrumenter(
        openTelemetry,
        AwsAdotInstrumenterFactory::spanName, // spanNameExtractor
